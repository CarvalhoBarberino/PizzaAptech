...
public class JanelaCadastrarPedido extends JFrame{
	...
	public JanelaCadastrarPedido(){
		setTitle("Cadastrar Pedidos"); setLocation(180, 180); setSize(650, 500); setResizable(true); setDefaultCloseOperation(EXIT_ON_CLOSE); getContentPane().setLayout(new FlowLayout());setVisible(true);
		int selecionado = 0;
		...
		bFecharPedido.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				Dao.fecharPedido(vecProdutoAdicionado, idDoCliente);
			}
		});
